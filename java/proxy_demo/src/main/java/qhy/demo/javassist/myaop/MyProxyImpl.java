...
/**
 * ClassName: qhy.demo.javassist.myaop.MyProxyImpl <br/>
 * Description: TODO 功能描述. <br/>
 * date: 2016年9月5日 下午4:42:35 <br/>
 * Company: gome
 * 
 * @author qihuiyong-ds
 * @version
...
public class MyProxyImpl {
	...
	/** 拦截器接口 */
	private final static String INTERCEPTOR_HANDLER_INTERFACE = "qhy.demo.javassist.myDynamicProxy.MyInvocationHandller";
	/** 动态代理类的类名索引，防止类名重复 */
	...
	private static void dynamicImplementsMethodsFromInterface(
			...
			Class interceptorClass, int methodIndex) throws CannotCompileException{
