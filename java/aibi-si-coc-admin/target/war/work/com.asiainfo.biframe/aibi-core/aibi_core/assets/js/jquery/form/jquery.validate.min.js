 ...
 *
 * $Id: jquery.validate.min.js,v 1.1 2010/10/11 02:17:32 zhangjd Exp $
 *
			...
			.extend(
					$.validator,
					{
						defaults : {
							...
							groups : {},
							rules : {},
							errorClass :"aibi_tips_little",//提示区域样式,原来是error
							validClass :"valid",
							errorElement :"span",//提示区域tagName,原来是label
							focusInvalid :true,
							errorContainer :$( []),
							errorLabelContainer :$( []),
							onsubmit :true,
						...
						messages : {
							required :$validmessages.required,
							remote :$validmessages.remote,
							email :$validmessages.email,
							url :$validmessages.url,
							date :$validmessages.date,
							dateISO :$validmessages.dateISO,
							dateDE :$validmessages.dateDE,
							number :$validmessages.number,
							numberDE :$validmessages.numberDE,
							digits :$validmessages.digits,
							creditcard :$validmessages.creditcard,
							equalTo :$validmessages.equalTo,
							accept :$validmessages.accept,
							maxlength :$.validator
									.format($validmessages.maxlength),
							minlength :$.validator
									.format($validmessages.minlength),
							rangelength :$.validator
									.format($validmessages.rangelength),
							range :$.validator
									.format($validmessages.range),
							max :$.validator
									.format($validmessages.max),
							min :$.validator
									.format($validmessages.min)
						},
