...
//        int[] aa =new int[10];
//        System.out.println((int)3.84D);
//        
//        List<String> skuParamList = new ArrayList<String>(10);
//		for (int i = 0;i < 10; i++) {
//			skuParamList.add("AA"+i);
//		}
//		System.out.println(skuParamList.toArray(new String[skuParamList.size()]));
